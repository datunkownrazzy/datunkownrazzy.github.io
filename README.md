# End Of TIMES Discord Bot

## Terms Of Service

TERMS OF SERVICE AGREEMENT

This Terms of Service Agreement (the "Agreement") is entered into between [Datunkownrazzy] & [LibexiL] ("Bot Owner") and the user ("User") of the [End of Times] Discord bot (the "Bot").
